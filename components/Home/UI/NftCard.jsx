    ...
    <article className="bg-card p-6 rounded-2xl">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between mb-2">
          <h6 className="text-white text-base font-bold">{data.name}</h6>
          <p className="text-gray-500 text-base">Current Bid</p>
        </div>
        <div className="flex items-center justify-between">
          <figure className="flex items-center gap-2">
            ...
            <p className="text-white text-sm">@{data.creatorName}</p>
          </figure>
          <h6 className="text-white text-base font-bold">{data.bid}</h6>
        </div>
      </div>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Image src={fireIcon} />
          <p className="text-white text-base font-bold">{data.time}</p>
        </div>
        <button className="bg-primary text-white font-semibold h-12 px-12 rounded-2xl shadow-p">
          Bid
        </button>
      </div>
    </article>
