...
const ArtistCard = ({ data }) => {
  return (
    <article className="bg-card flex flex-col items-center justify-center rounded-2xl">
      <div className="relative mb-16 w-full h-40 lg:h-52">
      ...
      <div className="pb-6 flex flex-col items-center justify-center">
        <h5 className="text-white text-base  lg:text-2xl font-bold mb-2">
          {data.name}
        </h5>
        <div className="flex items-center gap-2">
          <Image src={eth} />
          <p className="text-white text-xs lg:text-base font-bold">
            {data.quantity}
          </p>
        </div>
      </div>
